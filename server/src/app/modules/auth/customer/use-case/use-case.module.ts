...
@Module({
    providers: [AuthCustomerSignInUseCase, AuthCustomerSignUpUseCase, AuthCustomerAuthorizationUseCase, AuthCustomerForgetPasswordUseCase, AuthCustomerResetPasswordUseCase],
})
