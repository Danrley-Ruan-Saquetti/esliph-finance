...
@Module({
    providers: [AuthUserSignInUseCase, AuthUserSignUpUseCase, AuthUserAuthorizationUseCase, AuthBankAccountSignInUseCase, AuthBankAccountAuthorizationUseCase, AuthUserExistsUseCase],
})
